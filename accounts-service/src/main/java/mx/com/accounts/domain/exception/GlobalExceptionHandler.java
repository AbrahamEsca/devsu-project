...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleInsufficientFundsException(InsufficientFundsException ex) {
		LOGGER.info("La cuenta no cuenta con saldo disponible: ", ex.getMessage());
    ...
    public ResponseEntity<Map<String, String>> handleIllegalArgumentException(IllegalArgumentException ex) {
		LOGGER.info("Se reportan los siguientes errores controlados: ", ex.getMessage());
	...
	public ResponseEntity<Map<String, String>> handleClientNotFoundException(AccountNotFoundException ex) {
	...
	public ResponseEntity<Map<String, String>> handleMovementNotFoundException(MovementNotFoundException ex) {
		LOGGER.info("No se encontro registros con los valores de busqueda: ", ex.getMessage());
